		...
		<div class="app_recent_post">
			...
			<?php
				...
				<div class="app_recent_img">
                                    <a href="<?php the_permalink(); ?>"><img src="<?php echo get_template_directory_uri();?>/script/timthumb.php?src=<?php print $post_img;?>&w=69&h=47&zc=1&q=100" alt="<?php echo substr($title,0,15);echo $newdots; ?>" class="app_recent_img_img" /></a>
				</div>
				<?php }else{
                                    ?>
                                <div class="app_recent_noimg">
                                    <div class="post_no_img"></div>
				</div>
                    <?php
                                } ?>
				<div class="app_recent_box <?php if(empty($post_img)){?>  <?php } ?>">
                                    <div class="app_recent_title <?php if(empty($post_img)){?>  <?php } ?>" id="post-<?php the_ID(); ?>">
